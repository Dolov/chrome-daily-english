      ...
      {dates.map((date) => {
        ...
        return (
          <div
            key={date}
            tabIndex={0}
            className="collapse collapse-open bg-base-200">
              ...
              {words.map((word) => {
                ...
                return (
                  <div key={text} className="flex justify-between">
                    ...
                    <div className="flex">
                      <img
                        onClick={googleTranslate.bind(null, text)}
                      ...
                      />
                      <img
                        onClick={baiduTranslate.bind(null, text)}
                        className="w-6 h-6 cursor-pointer hover:scale-105 ml-4"
                      ...
                      />
                      <img
                        onClick={youdaoTranslate.bind(null, text)}
                        className="w-6 h-6 cursor-pointer hover:scale-105 ml-4"
